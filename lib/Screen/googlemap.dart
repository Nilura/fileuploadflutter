...
class Map extends StatefulWidget {
  String text;
  Map({Key key,this.text}) : super(key: key);
  @override
...
class MapState extends State<Map> {
  ...
  Future<void> _minus(double zoomVal) async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: LatLng(5.9380921,80.5739403), zoom: zoomVal)));
  }
...
Marker gramercyMarker = Marker(
  markerId: MarkerId('University of Ruhuna'),
  position: LatLng(5.9380974,5739403),
  infoWindow: InfoWindow(title: 'Ruhuna'),
...
Marker bernardinMarker = Marker(
  markerId: MarkerId('Kaluthara'),
  position: LatLng(6.5878738,79.9421542),
  infoWindow: InfoWindow(title: 'Kaluthara'),
  icon: BitmapDescriptor.defaultMarkerWithHue(
    BitmapDescriptor.hueViolet,
  ),
);
Marker blueMarker = Marker(
  markerId: MarkerId('Science Faculty'),
  position: LatLng(5.9397871, 80.5746632),
  infoWindow: InfoWindow(title: 'Science Faculty'),
  icon: BitmapDescriptor.defaultMarkerWithHue(
    BitmapDescriptor.hueViolet,
  ),
);
